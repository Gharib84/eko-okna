                        ...
                        <div class="mx-auto w-full">
                            <form action="{{ route('Przyjęcieartykułu.store') }}" method="post"
                                ...
                                <div class="mb-5">
                                    ...
                                    <select name="Jednostka_miary" id="Jednostka_miary"
                                        class="block mt-1 w-full bg-slate-700 text-white">
                                        <option selected>Wybierz jednostkę miary</option>
                                        @foreach ($artykuły as $artykuł)
                                            <option class="white" value="{{ $artykuł->Jednostka_miary }}">
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="file" name="files[]" id="file"
                                        class="w-full rounded-md border border-[#abaab6] py-3 px-6 text-base font-medium text-[#83c41c] outline-none focus:border-[#6A64F1] focus:shadow-md bg-slate-800"
                                        multiple />
